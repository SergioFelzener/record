...
populateWorkingHours(22, date('Y-m-1', $lastYear), 70, 20, 10);
populateWorkingHours(23, date('Y-m-1', $lastYear), 50, 30, 20);
...
populateWorkingHours(31, date('Y-m-d', $lastYear), 20, 10, 70);
populateWorkingHours(32, date('Y-m-1', $lastYear), 70, 20, 10);
populateWorkingHours(33, date('Y-m-1', $lastYear), 50, 30, 20);
populateWorkingHours(34, date('Y-m-d', $lastYear), 20, 10, 70);
populateWorkingHours(35, date('Y-m-d', $lastYear), 10, 20, 70);
populateWorkingHours(36, date('Y-m-d', $lastYear), 10, 10, 80);
populateWorkingHours(37, date('Y-m-d', $lastYear), 50, 10, 40);
populateWorkingHours(38, date('Y-m-d', $lastYear), 10, 70, 20);
populateWorkingHours(39, date('Y-m-d', $lastYear), 30, 30, 40);
populateWorkingHours(40, date('Y-m-d', $lastYear), 20, 10, 70);
