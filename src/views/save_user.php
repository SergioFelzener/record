    ...
    <form action="#" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="name" name="name" value="<?= $name ?>" placeholder="Informe o nome" class="form-control <?= $errors['name'] ? 'is-invalid' : '' ?>" value="<?= $name ?>">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="email" id="email" name="email" value="<?= $email ?>" placeholder="Informe o email" class="form-control <?= $errors['email'] ? 'is-invalid' : '' ?>" value="<?= $email ?>">
                <div class="invalid-feedback">
                    <?= $errors['email'] ?>
                </div>
            </div>
        ...
        <div class="form-row">
            <div class="form-group">
                <div class="form-check">
                    <input style="width: 1rem;" type="checkbox" id="is_admin" name="is_admin" class="form-control mr-3 <?= $errors['is_admin'] ? 'is-invalid' : '' ?>" <?= $is_admin ? 'checked' : '' ?>>
                    <label for="is_admin">
                        Administrador
                    </label>
                </div>
        ...
        <div>
            ...
            <a href="/users.php" class="btn btn-danger btn-lg float-right mr-2">Cancelar</a>
        </div>
    </form>
</main>