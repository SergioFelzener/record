                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <?php if ($user->photo) : ?>
                                                <img class="h-10 w-10 rounded-full" src="assets/uploads/<?= $user->photo ?>" alt="foto do usuário">
                                            <?php else : ?>
                                                <img class="h-10 w-10 rounded-full " src="assets/img/user_sem_foto.png" alt="foto do usuário">
                                            <?php endif ?>
                                            </div>
                                            <div class="ml-4">
